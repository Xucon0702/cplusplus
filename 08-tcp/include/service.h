...
#define READ_PER_SIZE 1  //每次读取的数据字节数
...
public:
	...
	void read()
	{
		...
		boost::asio::async_read(m_socket, boost::asio::buffer(m_getData, READ_PER_SIZE),//MSG_HEAD_SIZE //一次性读MSG_HEAD_SIZE个字节，满这么多字节数才会完成async_read
