/*
 * Filename: fyaml-example.c
 *
 * Copyright (C) 2018-2023 wangzhen3  <wangzhen3@motovis.com>. All Rights Reserved.
 *
 * History:
 *    2022/08/05 - [wangzhen3] Created file
 *
 * Maintainer: wangzhen3 <wangzhen3@motovis.com>
 *    Created: 2022-08-05
 * LastChange: 2022-08-05
 *    Version: v0.0.01
 *
 */
...
int main(int argc, char *argv[])
{
	...
	//rc = fy_emit_document_to_file(fyd, FYECF_DEFAULT | FYECF_SORT_KEYS, stdout);
	rc = fy_emit_document_to_file(fyd, FYECF_DEFAULT | FYECF_SORT_KEYS, argv[2]);
	if (rc) {
